...
const flowers = [
    ...
    { name: 'Георгина', description: 'Георгина - символ упорства и стойкости. Вы будете полны силы перед любыми невзгодами!', img: '/images/flower55.jpg' },
    ...
    { name: 'Лилия', description: 'Лилия - символ чистоты, искренности и благородства, а в восточных культурах - силу духа. Лилия привнесет в вашу жизнь эти чудесные качества!', img: '/images/flower8.webp' },
    { name: 'Орхидея', description: 'Орхидея символизирует любовь, нежность и красоту, что и привнесет в вашу жизнь!', img: '/images/flower9.jpg' },
